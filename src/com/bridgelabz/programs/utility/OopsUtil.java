...
public class OopsUtil 
{
	...
	public static String[]  createDeckOfcard ( String[] suit ,String [] rank) 
	{
	...
	public static void randomCard( String [] deckOfCard ) 
	{
	...
	public static void distributeCardAndPrint( String []deckOfCard) 
	{
	...
	public static String [][]  distributeCard( String []deckOfCard) 
	{
		String [][] cardDistribute = new String[4][9] ;
		int count = 0 ;
	...
	public static void sortCard( String [][] distributeCard , String []card ) 
	{
		int array[] = new int [9] ;
		int l = 0;
		for( int i = 0 ; i < 1 ; i++ ) 
	...
	public static String [][] relaceMethodToString ( int [][] array)
	     {
	...
	public static int[][]  replaceMethodToInt (String [][] distributeCard  ) 
	{ 
	...
	public static void  displayCard(String [][] cardDistribute)
	{	
		for( int i = 0 ; i< cardDistribute.length ; i++  ) 
		{
			System.out.println("player "+(i+1)+" card : ") ;

...
import com.bridgelabz.programs.datastructure.Queue;
import com.bridgelabz.programs.datastructure.stack;
		 ...
		 //	listOfTra.addAll(listOfTra) ;
			...
			for(int i = 0; i< userlist.size(); i++) 	{
				if(userName.equalsIgnoreCase(user.getUserList().get(i).getName()) ) 
				{
					...
					System.out.println("UserSellShare"+user.getUserList().get(i).getSellShare());
					System.out.println("userBuyShare"+user.getUserList().get(i).getBuyShare());
					listNumber = i;
					break;
				}
